...
private:
	...
	struct Node
	{
		...
		********************************************************/
		...
		/*********************************************************
		* @brief	コンストラクタ　スコアデータで初期化
		* @param	スコアデータ
		********************************************************/
		Node(const ScoreData& _data);	
	};
...
public:
	...
	class ConstIterator
	{
	// @brief	DoubleLinkedListの関数内で、有効イテレータ確認するため
	...
	public:
		...
		********************************************************/
		...
		/*********************************************************
		* @brief	コンストラクタ　指す位置を初期化
		* @param	指したいノードへのポインタ、このノードのリストへのポインタ
		********************************************************/
		ConstIterator(Node* node, const DoubleLinkedList* list) :
			m_pNode(node), m_pList(list) { };						
	...
	public:
		...
		* @param	指したいノードへのポインタ、このノードのリストへのポインタ
		********************************************************/
		Iterator(Node* node, DoubleLinkedList* list) :
